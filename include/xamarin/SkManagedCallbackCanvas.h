...
#define ANDROIDUI_PROC(name) typedef void (*name) (SkManagedCallbackCanvas* d, void* context
    ...
    ANDROIDUI_PROC(matrix_proc), sk_matrix_t matrix);
    ...
    ANDROIDUI_PROC(image_float_float_paint_proc), const sk_image_t* image, float x, float y, const sk_paint_t* paint);
    ANDROIDUI_PROC(image_irect_rect_paint_proc), const sk_image_t* image, const sk_irect_t* center, const sk_rect_t* dest, const sk_paint_t* paint);
    ANDROIDUI_PROC(image_rect_rect_proc), const sk_image_t* image, const sk_rect_t* src, const sk_rect_t* dest, const sk_paint_t* paint);
    ANDROIDUI_PROC(image_lattice_rect_paint_proc), const sk_image_t* image, const sk_lattice_t* lattice, const sk_rect_t* dest, const sk_paint_t* paint);
    ...
    ANDROIDUI_PROC(atlas_rsxform_rect_color_int_blendmode_rect_paint_proc), const sk_image_t* atlas, const sk_rsxform_t* xform, const sk_rect_t* tex, const sk_color_t* colors, int count, sk_blendmode_t mode, const sk_rect_t* cullRect, const sk_paint_t* paint);
...
#undef ANDROIDUI_PROC
    ...
    struct Procs {
        ...
        image_float_float_paint_proc fDrawImage;
        image_irect_rect_paint_proc fDrawImageNine;
        image_lattice_rect_paint_proc fDrawImageLattice;
        image_rect_rect_proc fDrawImageRect;
        ...
        atlas_rsxform_rect_color_int_blendmode_rect_paint_proc fDrawAtlas;
