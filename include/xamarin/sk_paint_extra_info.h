...
SK_X_API sk_font_t* sk_paint_extra_info_clone_font(sk_paint_extra_info_t* paint);
SK_X_API sk_paint_t* sk_paint_extra_info_clone_paint(sk_paint_extra_info_t* paint);
